...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-900 to-green-800 flex flex-col items-center p-4 relative overflow-hidden">
      ...
      {message && (
        <div
          className={`w-full max-w-6xl mb-6 p-4 rounded-lg text-center font-bold text-xl z-10 animate-bounce
          ${
              ...
              dealerHand.map((card, index) => (
                ...
                >
                  {card.suit === "?" ? (
                    ...
                    <>
                      <div
                        className={`self-start text-2xl font-bold ${getCardColor(
                          card.suit
                        )}`}
                      >
                        {card.rank}
                      ...
                      <div
                        className={`self-center text-4xl ${getCardColor(
                          card.suit
                        )}`}
                      >
                        {card.suit}
                      ...
                      <div
                        className={`self-end text-2xl font-bold rotate-180 ${getCardColor(
                          card.suit
                        )}`}
                      >
                        {card.rank}
